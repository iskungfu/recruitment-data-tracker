...
| `keywords` | 0（静态） | 34 行 | PRD §3.1 全量关键词（2026-09-23 裁决：前端 3 词） |
| `snapshots` | 34 × 5 × 1 = 170 行 | 680 行 | 每关键词每城一次采集任务记录 |
| `job_snapshot` | ≤5000 行 | ≤20000 行 | 每关键词每城 ≤10 页 ≈ 300 条，34 关键词 × 5 城 ≈ 实际去重后约 3000-5000 |
